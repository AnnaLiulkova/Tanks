...
namespace Tanks.Complete
{
    ...
    public class TankMovement : MonoBehaviour
    {
        ...
        private void Move ()
        {
            ...
            if (m_ExplosionForceValue.sqrMagnitude > 0.01f)
            {
                m_Rigidbody.AddForce(m_ExplosionForceValue * 0.1f, ForceMode.VelocityChange);
                m_ExplosionForceValue = Vector3.zero; // застосовуємо один раз і скидаємо
            }
